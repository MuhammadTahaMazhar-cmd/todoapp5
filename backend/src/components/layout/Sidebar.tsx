...
export function Sidebar({ sidebarOpen, setSidebarOpen, setDarkMode, onCreateTask }: SidebarProps) {
  ...
  const navItems = [
    ...
    { href: '/calendar', icon: Calendar, label: 'Task Calendar' },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-6 border-b border-slate-200 dark:border-zinc-800">
            <Link href="/dashboard" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-slate-900 dark:text-white font-playfair underline-gradient">TaskMaster</span>
            </Link>
            <button
              onClick={() => setSidebarOpen(false)}
