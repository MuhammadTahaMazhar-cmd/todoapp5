...
function CalendarContent() {
  ...
  const getTaskCountForDate = (date: Date): { total: number; completed: number; active: number } => {
                      ...
                      {hasTasks && (
                        <div className="flex-1 flex flex-col items-center justify-center gap-1">
                          <div className="flex gap-1 items-center">
                            {taskCount.active > 0 && (
                              <div className="w-2 h-2 rounded-full bg-blue-500" title={`${taskCount.active} active`} />
                            )}
